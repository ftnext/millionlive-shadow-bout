...
def resume_effect(state: GameState, choice: str | None = None) -> GameState:
    ...
    if effect == "choose":
        state = _resume_choose(state, side, choice)
    elif effect == "copy_hand":
        state = _resume_copy_hand(state, side, choice)
    elif effect == "search_and_swap":
        state = _resume_search_and_swap(state, side, choice)
    elif effect == "swap":
        state = _resume_swap(state, side, choice)
    elif effect == "removal":
        state = _resume_removal(state, side, choice)
    else:
        state = _finish_interactive_effect(state, "-> 選択完了")
